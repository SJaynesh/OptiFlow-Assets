...
class _HomePageComponetState extends State<HomePageComponet> {
  ...
  Widget build(BuildContext context) {
    ...
    Future.delayed(const Duration(seconds: 6), () {
      Provider.of<ProductController>(context, listen: false).getIsShimmer();
    });
      ...
      body: Padding(
        ...
        child: Consumer<ProductController>(
          builder: (context, controller, child) {
            return (!controller.productModel.isShimmer)
                ? Shimmer.fromColors(
                          ...
                          child: Column(
                            children: [
                              Expanded(
                                child: StreamBuilder(
                                  stream:
                                      FCMHelper.fcmHelper.getEarningAndSales(),
                                  builder: (context, snapshot) {
                                    if (snapshot.hasData) {
                                                                ...
                                                                Navigator.of(
                                                                  ...
                                                                  PageRouteBuilder(
                                                                    pageBuilder: (context,
                                                                      ...
                                                                      data: {
                                                                        'color': Colors
                                                                            .primaries[controller.productModel.Products.indexOf(element) %
                                                                                18]
                                                                            .withOpacity(0.3),
                                                                        'data':
                                                                            element,
